...
const SLIDE_TITLES = [
  ...
  "Encuesta · Servicio digital crítico",
  "Encuesta · Redes en una palabra",
  "Mapa del tema",
  "Red de computadores",
  "Telemática",
  ...
  "Pipeline",
  "Encuesta · Mensajes frente a paquetes",
  ...
  "Encuesta · Datagrama vs circuito virtual",
  "Tamaño y retardo",
  "Segmentación y pipeline",
  "Transmisión y propagación",
  "Laboratorio · Transmisión vs propagación",
  "Encuesta · Transmisión vs propagación",
  "Latencia y caudal",
  "Encuesta · Servicios sensibles",
